      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 max-w-6xl mx-auto">
          {plans.map((plan) => (
            <div
              key={plan.id}
              className={`relative bg-white rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-2 ${
                plan.popular 
            ...
            >
              ...
              <div className="p-8">
                ...
                {/* CTA Button */}
                <button className={`w-full py-4 bg-gradient-to-r ${plan.buttonColor} text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg`}>
                  {plan.buttonText}
                </button>
              </div>
            </div>
